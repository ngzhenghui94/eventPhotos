		...
		<main className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-blue-50 fade-in-up">
			<section className="py-16 sm:py-24 relative overflow-hidden">
				...
				<div className="text-center mb-12 fade-in-up">
					<h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 mb-4">Upgrade Your {brand.productName} Plan</h1>
					<p className="text-xl text-gray-700">
						Select a plan to unlock more features and events
					</p>
				</div>
