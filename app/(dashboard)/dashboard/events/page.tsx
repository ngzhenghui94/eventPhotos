            ...
            <div className="flex-shrink-0 hidden md:block">
              <div className="w-32 h-32 rounded-full shadow-lg border-4 border-orange-200 bg-white flex items-center justify-center">
                <svg width="64" height="64" viewBox="0 0 256 256" aria-hidden>
                  <defs>
                    <linearGradient id="tcg-hero-2" x1="0" y1="0" x2="1" y2="1">
                      <stop offset="0%" stopColor="#f59e0b" />
                      <stop offset="100%" stopColor="#fb923c" />
                    </linearGradient>
                  </defs>
                  <rect width="256" height="256" rx="48" fill="url(#tcg-hero-2)" />
            ...
            <CardContent className="p-4">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-blue-800">{items.reduce((total, e) => total + Number(e.photoCount ?? 0), 0)}</p>
                </div>
              </div>
            </CardContent>
          </Card>
